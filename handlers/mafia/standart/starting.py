...
@dp.callback_query_handler(lambda callback: callback.data == 'standart')
...
@dp.message_handler(lambda message: proccess_validate_name(message), state=StandartMafiaForm.name)
